...
writeToLog(5, true, 'Prozess QUEUE gestartet');
sql_connect();
$procControl = null;
...
do {
    ...
    if ($procTrigger[0]) {
        ...
        if ($procControl == 0) {
            ...
            writeToLog(5, true, 'Prozess QUEUE beenden...');
...
function exitSelf()
{
    writeToLog(5, sql_disconnect(), 'Datenbank: Verbindung schließen');
    writeToLog(5, true, 'Prozess QUEUE beendet');
    exit();
}
