...
class procSysinfo
{
    ...
    {
        writeToLog(2, true, 'Process SYSINFO started');
        sql_connect();
    ...
    private function proc_check()
    {
        ...
        if ($this->procTrigger[0]) {
            ...
            if ($this->procControl == 1) {
                writeToLog(2, true, 'stopping process SYSINFO...');
            } else {
                return true;
            }
        }
    ...
    {
        writeToLog(2, sql_disconnect(), 'Database: close connection');
        writeToLog(2, true, 'process SYSINFO stopped');
        exit();
    }
} 
?>
