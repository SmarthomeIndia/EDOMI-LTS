...
function cmd($cmd)
{
    ...
    if ($cmd == 'initApp') { ?>
        ...
        <div class='appWindowDrag' id='<? echo $winId; ?>-global'>";
            n+="
            <div class='appTitelDrag' onMouseDown='dragWindowStart(\"<? echo $appId; ?>\",\"<? echo $winId; ?>-global\");'>Kameraansicht: Einstellungen
                <div class='cmdClose' onClick='closeWindow(\"<? echo $winId; ?>\");'></div>
                <div class='cmdHelp' onClick='openWindow(9999,\"<? echo $appId; ?>\");'></div>
            </div>
            ";
            n+="
            <div id='<? echo $winId; ?>-main' style='width:1024px;'></div>
            ";
            n+="
        </div>";
    ...
    if ($cmd == 'start') { ?>
        ...
        <div class='appMenu'>";
            ...
            <div class='cmdButton cmdButtonR'
                 onClick='ajax(\"return\",\"<? echo $appId; ?>\",\"<? echo $winId; ?>\",\"<? echo $data; ?>\",\"<? echo $phpdata; ?>\");'><b>Übernehmen</b>
            </div>&nbsp;&nbsp;&nbsp;";
            n+="
            <div class='cmdButton'
                 onClick='ajax(\"refreshImage\",\"<? echo $appId; ?>\",\"<? echo $winId; ?>\",\"<? echo $data; ?>\",\"<? echo $phpdata; ?>\");'
                 style='float:right;'>Bild aktualisieren
            </div>
            ";
            n+="
        </div>";
            ...
            <table width='100%' border='0' cellpadding='2' cellspacing='0'>";
                ...
                <tr valign='top'>";
                    ...
                    <td colspan='2' width='495'>";
                        n+="
                        <canvas id='<? echo $winId; ?>-canvas1' style='width:495px; height:371px; background:#343434;'></canvas>
                        ";
                        n+="
                    </td>
                    ";
                    ...
                    <td colspan='2' width='495'>";
                        n+="
                        <canvas id='<? echo $winId; ?>-canvas2' style='width:495px; height:371px; background:#343434;'></canvas>
                        ";
                        n+="
                    </td>
                    ";
        ...
        <tr>";
            n+="
            <td colspan='2'>Zoom <span id='<? echo $winId; ?>-v10' style='float:right;'></span><br><input id='<? echo $winId; ?>-fd10' data-type='1'
                                                                                                          type='range' class='controlSlider' min='0' max='500'
                                                                                                          value='' step='1'
                                                                                                          onInput='app1020_changeValue(\"<? echo $winId; ?>\",10,\"db_zoom\",this.value);'
                                                                                                          style='width:100%;'></td>
            ";
            n+="
            <td width='3' style='height:35px;'>
                <div style='width:2px;'></div>
            </td>
            ";
            n+="
            <td>Seitenverhältnis: Breite<br><input type='text' id='<? echo $winId; ?>-fd15' data-type='1' value='' class='control1'
                                                   onChange='app1020_changeValue(\"<? echo $winId; ?>\",15,\"db_dstw\",this.value);'
                                                   style='width:100%;'></input></td>
            ";
            n+="
            <td>Höhe<br><input type='text' id='<? echo $winId; ?>-fd16' data-type='1' value='' class='control1'
                               onChange='app1020_changeValue(\"<? echo $winId; ?>\",16,\"db_dsth\",this.value);' style='width:100%;'></input></td>
            ";
            n+="
        </tr>";
        ...
        <tr>";
            n+="
            <td colspan='2'>Rotieren <span id='<? echo $winId; ?>-v12' style='float:right;'></span><br><input id='<? echo $winId; ?>-fd12' data-type='1'
                                                                                                              type='range' class='controlSlider' min='-180'
                                                                                                              max='180' value='' step='1'
                                                                                                              onInput='app1020_changeValue(\"<? echo $winId; ?>\",12,\"db_a2\",this.value);'
                                                                                                              style='width:100%;'></td>
            ";
            n+="
            <td width='3' style='height:35px;'>
            ...
            ";
            n+="
            <td colspan='2'>Auflösung <span id='<? echo $winId; ?>-v20' style='float:right;'></span><br><input id='<? echo $winId; ?>-fd20' data-type='1'
                                                                                                               type='range' class='controlSlider' min='10'
                                                                                                               max='100' value='50' step='5'
                                                                                                               onInput='app1020_changeValue(\"<? echo $winId; ?>\",20,\"db_srcs\",this.value);'
                                                                                                               style='width:100%;'></td>
            ";
            n+="
        </tr>";
        ...
        <tr>";
            n+="
            <td colspan='2'>Verschieben (horizontal) <span id='<? echo $winId; ?>-v13' style='float:right;'></span><br><input id='<? echo $winId; ?>-fd13'
                                                                                                                              data-type='1' type='range'
                                                                                                                              class='controlSlider' min='-100'
                                                                                                                              max='100' value='' step='1'
                                                                                                                              onInput='app1020_changeValue(\"<? echo $winId; ?>\",13,\"db_x\",this.value);'
                                                                                                                              style='width:100%;'></td>
            ";
            n+="
            <td width='3' style='height:35px;'>
        ...
        <tr>";
            n+="
            <td colspan='2'>Verschieben (vertikal) <span id='<? echo $winId; ?>-v14' style='float:right;'></span><br><input id='<? echo $winId; ?>-fd14'
                                                                                                                            data-type='1' type='range'
                                                                                                                            class='controlSlider' min='-100'
                                                                                                                            max='100' value='' step='1'
                                                                                                                            onInput='app1020_changeValue(\"<? echo $winId; ?>\",14,\"db_y\",this.value);'
                                                                                                                            style='width:100%;'></td>
            ";
            n+="
            <td width='3' style='height:35px;'>
        ...
        <tr>";
            n+="
            <td colspan='2'>Neigen <span id='<? echo $winId; ?>-v11' style='float:right;'></span><br><input id='<? echo $winId; ?>-fd11' data-type='1'
                                                                                                            type='range' class='controlSlider' min='-90'
                                                                                                            max='90' value='' step='1'
                                                                                                            onInput='app1020_changeValue(\"<? echo $winId; ?>\",11,\"db_a1\",this.value);'
                                                                                                            style='width:100%;'></td>
            ";
            n+="
            <td width='3' style='height:35px;'>
        ...
        <tr>";
            n+="
            <td colspan='2'>Schwenken <span id='<? echo $winId; ?>-v12' style='float:right;'></span><br><input id='<? echo $winId; ?>-fd12' data-type='1'
                                                                                                               type='range' class='controlSlider' min='-180'
                                                                                                               max='180' value='' step='1'
                                                                                                               onInput='app1020_changeValue(\"<? echo $winId; ?>\",12,\"db_a2\",this.value);'
                                                                                                               style='width:100%;'></td>
        ...
        <tr>";
            ...
            ";
            n+="
            <td colspan='2'>Anpassung: Radius <span id='<? echo $winId; ?>-v18' style='float:right;'></span><br><input id='<? echo $winId; ?>-fd18'
                                                                                                                       data-type='1' type='range'
                                                                                                                       class='controlSlider' min='-100'
                                                                                                                       max='100' value='' step='1'
                                                                                                                       onInput='app1020_changeValue(\"<? echo $winId; ?>\",18,\"db_srcr\",this.value);'
                                                                                                                       style='width:100%;'></td>
            ";
            n+="
        </tr>";
        ...
        <tr>";
            ...
            ";
            n+="
            <td colspan='2'>Anpassung: perspektivische Verzerrung <span id='<? echo $winId; ?>-v19' style='float:right;'></span><br><input
                    id='<? echo $winId; ?>-fd19' data-type='1' type='range' class='controlSlider' min='-90' max='90' value='' step='1'
                    onInput='app1020_changeValue(\"<? echo $winId; ?>\",19,\"db_srcd\",this.value);' style='width:100%;'></td>
            ";
            n+="
        </tr>";
    ...
    if ($cmd == 'loadImage') {
        $n = sql_getValues('edomiProject.editCam', 'url,mjpeg', 'id=' . $phpdataArr[1]);
        if ($n !== false) {
            $imgFn = getLiveCamImgPreview($n['url'], $n['mjpeg']);
            if ($imgFn !== false) {
                return '../data/tmp/' . $imgFn . '?' . date('YmdHis');
            }
        }
        return false;
    }
