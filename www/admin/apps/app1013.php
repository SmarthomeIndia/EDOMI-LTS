...
function cmd($cmd)
{
    ...
    if ($cmd == 'initApp') { ?>
        var n="
        <div class='appWindowConfirm' style='text-align:center;'>";
            n+="
            <div style='color:#ffffff;'>Markierte Visuelemente mit Cursortasten bewegen<br>(Übernehmen: ENTER / Abbruch: ESC)</div>
            ";
            n+="
        </div>";
