...
<? } ?>
	...
	<body onLoad='showHelp();' style="font-family:<?echo global_adminFont;?>; background:-webkit-linear-gradient(top, #ffffff 0px,#f0f0e9 80px,#ffffff 80px); text-align:left; background-repeat:no-repeat; -webkit-user-select:auto; overflow:auto;">
		<div class='appTitel' style='margin:0; padding:5px 0 5px 0;'>EDOMI <?echo global_version;?> &middot; &copy; Long Term Evolution <div id='filename' style='float:right;'></div></div>
		<div class='appMenu' style='margin:5px 0 0 0; padding:0;'>
			<table id='<?echo $winId;?>-form1' width='100%' border='0' cellpadding='0' cellspacing='0' style='margin-top:5px; table-layout:auto;'>
				<tr>
					<td width='30px'><div class='cmdButton' onClick='history.back();'>&lt;</div></td>
					<td style='padding-left:2px;'><input type='text' id='search' data-type='1' autofocus value='' onkeydown='if (event.keyCode==13) {search();}' class='control1' style='width:100%; height:27px; margin:0; outline:none;'></input></td>
				</tr>
			</table>
		</div>
		<table width='100%' border='0' cellpadding='0' cellspacing='0' style='padding-top:15px; table-layout:auto;'>
			<tr valign='top'>
				<td width='1' style='zoom:115%;'><div id='menuRoot' class='columnMenu' style='height:100%;'></div></td>
				<td><div id='help' class='columnContent' style='zoom:115%; line-height:1.5; font-family:<?echo global_adminFont;?>; font-size:10px; padding-left:10px; box-sizing:border-box;'></div></td>
			</tr>
		</table>
	</body>	
</html>
