...
function LB_LBSID($id)
{
    if ($E = logic_getInputs($id)) {
        if (!isEmpty($E[16]['value']) && $E[16]['refresh'] == 1) {
            logic_setOutput($id, 1, $E[16]['value']);
        }
        if (!isEmpty($E[15]['value']) && $E[15]['refresh'] == 1) {
            logic_setOutput($id, 1, $E[15]['value']);
        }
        if (!isEmpty($E[14]['value']) && $E[14]['refresh'] == 1) {
            logic_setOutput($id, 1, $E[14]['value']);
        }
        if (!isEmpty($E[13]['value']) && $E[13]['refresh'] == 1) {
            logic_setOutput($id, 1, $E[13]['value']);
        }
        if (!isEmpty($E[12]['value']) && $E[12]['refresh'] == 1) {
            logic_setOutput($id, 1, $E[12]['value']);
        }
        if (!isEmpty($E[11]['value']) && $E[11]['refresh'] == 1) {
            logic_setOutput($id, 1, $E[11]['value']);
        }
        if (!isEmpty($E[10]['value']) && $E[10]['refresh'] == 1) {
            logic_setOutput($id, 1, $E[10]['value']);
        }
        if (!isEmpty($E[9]['value']) && $E[9]['refresh'] == 1) {
