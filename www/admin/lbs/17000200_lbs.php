...
function LB_LBSID($id)
{
    if ($E = logic_getInputs($id)) {
        ...
        if ($E[1]['refresh'] == 1) { //NEUER Tastendruck?
            if ($E[1]['value'] == 1 && ($E[2]['value'] == 1 || array_search('1', $tmp) !== false)) {
                logic_setOutput($id, 1, 1);
            }
            if ($E[1]['value'] == 2 && ($E[2]['value'] == 1 || array_search('2', $tmp) !== false)) {
                logic_setOutput($id, 2, 1);
            }
            if ($E[1]['value'] == 3 && ($E[2]['value'] == 1 || array_search('3', $tmp) !== false)) {
                logic_setOutput($id, 3, 1);
            }
            if ($E[1]['value'] == 4 && ($E[2]['value'] == 1 || array_search('4', $tmp) !== false)) {
                logic_setOutput($id, 4, 1);
            }
            if ($E[1]['value'] == 5 && ($E[2]['value'] == 1 || array_search('5', $tmp) !== false)) {
                logic_setOutput($id, 5, 1);
            }
            if ($E[1]['value'] == 6 && ($E[2]['value'] == 1 || array_search('6', $tmp) !== false)) {
                logic_setOutput($id, 6, 1);
            }
            if ($E[1]['value'] == 7 && ($E[2]['value'] == 1 || array_search('7', $tmp) !== false)) {
                logic_setOutput($id, 7, 1);
            }
            if ($E[1]['value'] == 8 && ($E[2]['value'] == 1 || array_search('8', $tmp) !== false)) {
                logic_setOutput($id, 8, 1);
            }
            if ($E[1]['value'] == 11 && ($E[2]['value'] == 1 || array_search('11', $tmp) !== false)) {
                logic_setOutput($id, 9, 1);
            }
            if ($E[1]['value'] == 12 && ($E[2]['value'] == 1 || array_search('12', $tmp) !== false)) {
                logic_setOutput($id, 10, 1);
            }
            if ($E[1]['value'] == 13 && ($E[2]['value'] == 1 || array_search('13', $tmp) !== false)) {
                logic_setOutput($id, 11, 1);
            }
            if ($E[1]['value'] == 14 && ($E[2]['value'] == 1 || array_search('14', $tmp) !== false)) {
                logic_setOutput($id, 12, 1);
            }
            if ($E[1]['value'] == 15 && ($E[2]['value'] == 1 || array_search('15', $tmp) !== false)) {
                logic_setOutput($id, 13, 1);
            }
            if ($E[1]['value'] == 16 && ($E[2]['value'] == 1 || array_search('16', $tmp) !== false)) {
                logic_setOutput($id, 14, 1);
            }
            if ($E[1]['value'] == 17 && ($E[2]['value'] == 1 || array_search('17', $tmp) !== false)) {
                logic_setOutput($id, 15, 1);
            }
            if ($E[1]['value'] == 18 && ($E[2]['value'] == 1 || array_search('18', $tmp) !== false)) {
