...
function LB_LBSID($id) {
	if (($E=logic_getInputs($id)) && ($V=logic_getVars($id))) {
		...
		if ($E[12]['value']!=0 && !isEmpty($E[11]['value'])) {
			if ($E[4]['value']!=0) {$V[1]|=8;} else {$V[1]&=~8;}
			if ($E[3]['refresh']==1) {
				if ($E[3]['value']!=0 && ~$V[1]&1 && $E[11]['value']<($E[7]['value']-$E[9]['value'])) {$V[1]|=4; $V[1]&=~2;} else {$V[1]&=~4;}
			}
			if ($E[2]['refresh']==1) {
				if ($E[2]['value']!=0 && ~$V[1]&1 && $E[11]['value']<($E[6]['value']-$E[9]['value'])) {$V[1]|=2; $V[1]&=~4;} else {$V[1]&=~2;}
			}
			if ($E[1]['refresh']==1) {
				if ($E[1]['value']!=0 && $E[11]['value']<($E[5]['value']-$E[9]['value'])) {$V[1]|=1; $V[1]&=~2; $V[1]&=~4;} else {$V[1]&=~1;}
			}
		...
		//Status: Warm/Kalt?
		if ($E[11]['value']>=($E[5]['value']-$E[9]['value'])) {$V[1]|=16;} else {$V[1]&=~16;}
		if ($E[11]['value']>=($E[6]['value']-$E[9]['value'])) {$V[1]|=32;} else {$V[1]&=~32;}
		if ($E[11]['value']>=($E[7]['value']-$E[9]['value'])) {$V[1]|=64;} else {$V[1]&=~64;}
		if ($E[11]['value']>=($E[8]['value']-$E[9]['value'])) {$V[1]|=128;} else {$V[1]&=~128;}

		//A1..8 (SBC)
		if ($V[1]&1 && (~$V[3]&1 || $V[3]==-1)) {logic_setOutput($id,1,1);} else if (~$V[1]&1 && ($V[3]&1 || $V[3]==-1)) {logic_setOutput($id,1,0);}
		if ($V[1]&2 && (~$V[3]&2 || $V[3]==-1)) {logic_setOutput($id,2,1);} else if (~$V[1]&2 && ($V[3]&2 || $V[3]==-1)) {logic_setOutput($id,2,0);}
		if ($V[1]&4 && (~$V[3]&4 || $V[3]==-1)) {logic_setOutput($id,3,1);} else if (~$V[1]&4 && ($V[3]&4 || $V[3]==-1)) {logic_setOutput($id,3,0);}
		if ($V[1]&8 && (~$V[3]&8 || $V[3]==-1)) {logic_setOutput($id,4,1);} else if (~$V[1]&8 && ($V[3]&8 || $V[3]==-1)) {logic_setOutput($id,4,0);}
		if ($V[1]&16 && (~$V[3]&16 || $V[3]==-1)) {logic_setOutput($id,5,1);} else if (~$V[1]&16 && ($V[3]&16 || $V[3]==-1)) {logic_setOutput($id,5,0);}
		if ($V[1]&32 && (~$V[3]&32 || $V[3]==-1)) {logic_setOutput($id,6,1);} else if (~$V[1]&32 && ($V[3]&32 || $V[3]==-1)) {logic_setOutput($id,6,0);}
		if ($V[1]&64 && (~$V[3]&64 || $V[3]==-1)) {logic_setOutput($id,7,1);} else if (~$V[1]&64 && ($V[3]&64 || $V[3]==-1)) {logic_setOutput($id,7,0);}
		if ($V[1]&128 && (~$V[3]&128 || $V[3]==-1)) {logic_setOutput($id,8,1);} else if (~$V[1]&128 && ($V[3]&128 || $V[3]==-1)) {logic_setOutput($id,8,0);}
