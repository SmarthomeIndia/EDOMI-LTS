...
Sobald dieser Ist-Wert (A2) den Schwellenwert an E8 (prozentual, d.h. relativ zu E7) unterschreitet, wird A1 auf 1 gesetzt: Dies sollte zu einer Chlorzugabe führen, mittels E3 des
<link>LBS 17900010***lbs_17900010</link> kann A1 direkt ausgewertet werden.
Dieser Umstand alleine führt jedoch
<i>nicht</i> zu einer Erfassung der zugegebenen Chlormenge - dies erfolgt erst, wenn E1 auf einen Wert &ne;0 gesetzt wird (s.o.)!
...
Dabei wird der Soll-Wert (E7) entsprechend erhöht, wenn der Wasserpegel seit der letzten Chlorierung gestiegen ist: Der
<i>geringste</i> Pegelstand wird fortlaufend intern gespeichert und bei der nächsten Chlorierung ausgewertet.
...
Bei Bedarf kann mittels E12&gt;0
<i>einmalig</i> eine beliebige Menge Chlor zugegeben werden. Wird E12 auf einen Wert &gt;0 gesetzt, wird dieser Chlormenge auf den Soll-Wert aufgeschlagen und somit bei der nächsten Chlorierung
<i>einmalig</i> zugegeben.
        ...
        while (logic_getEdomiState() == 1) {
            ...
            if ($this->getE() && $this->getV()) {
                ...
                if ($this->E[7]['value'] > 0) {
                    ...
                    if (!is_numeric($this->E[9]['value'])) {
                        $this->E[9]['value'] = 0;
                    }
                    if (!is_numeric($this->E[3]['value'])) {
                        $this->E[3]['value'] = 20;
                    }
