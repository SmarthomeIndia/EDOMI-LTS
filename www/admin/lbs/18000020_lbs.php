	...
	if ($E=logic_getInputs($id)) {
		...
		if ($E[1]['refresh']==1 && $E[1]['value']>0) {
			...
			if ($E[1]['value']>0 && $E[2]['value']>0 && $E[3]['value']>=0 && $E[3]['value']<=5) {
				...
				if ($E[3]['value']==0) {$ss1=sql_call("SELECT COUNT(gavalue) AS vanz,AVG(CAST(gavalue AS DECIMAL(20,4))) AS vavg,MIN(CAST(gavalue AS DECIMAL(20,4))) AS vmin,MAX(CAST(gavalue AS DECIMAL(20,4))) AS vmax,SUM(CAST(gavalue AS DECIMAL(20,4))) AS vsum FROM (SELECT gavalue FROM edomiLive.archivKoData WHERE (targetid=".$E[2]['value'].") ORDER BY datetime DESC,ms DESC LIMIT 0,".$E[1]['value'].") void");}
				else if ($E[3]['value']==1) {$ss1=sql_call("SELECT COUNT(gavalue) AS vanz,AVG(CAST(gavalue AS DECIMAL(20,4))) AS vavg,MIN(CAST(gavalue AS DECIMAL(20,4))) AS vmin,MAX(CAST(gavalue AS DECIMAL(20,4))) AS vmax,SUM(CAST(gavalue AS DECIMAL(20,4))) AS vsum FROM (SELECT gavalue FROM edomiLive.archivKoData WHERE (targetid=".$E[2]['value']." AND UNIX_TIMESTAMP(datetime)>=".strtotime('now -'.$E[1]['value'].' seconds').")) void");}
				else if ($E[3]['value']==2) {$ss1=sql_call("SELECT COUNT(gavalue) AS vanz,AVG(CAST(gavalue AS DECIMAL(20,4))) AS vavg,MIN(CAST(gavalue AS DECIMAL(20,4))) AS vmin,MAX(CAST(gavalue AS DECIMAL(20,4))) AS vmax,SUM(CAST(gavalue AS DECIMAL(20,4))) AS vsum FROM (SELECT gavalue FROM edomiLive.archivKoData WHERE (targetid=".$E[2]['value']." AND UNIX_TIMESTAMP(datetime)>=".strtotime('now -'.$E[1]['value'].' minutes').")) void");}
				else if ($E[3]['value']==3) {$ss1=sql_call("SELECT COUNT(gavalue) AS vanz,AVG(CAST(gavalue AS DECIMAL(20,4))) AS vavg,MIN(CAST(gavalue AS DECIMAL(20,4))) AS vmin,MAX(CAST(gavalue AS DECIMAL(20,4))) AS vmax,SUM(CAST(gavalue AS DECIMAL(20,4))) AS vsum FROM (SELECT gavalue FROM edomiLive.archivKoData WHERE (targetid=".$E[2]['value']." AND UNIX_TIMESTAMP(datetime)>=".strtotime('now -'.$E[1]['value'].' hours').")) void");}
				else if ($E[3]['value']==4) {$ss1=sql_call("SELECT COUNT(gavalue) AS vanz,AVG(CAST(gavalue AS DECIMAL(20,4))) AS vavg,MIN(CAST(gavalue AS DECIMAL(20,4))) AS vmin,MAX(CAST(gavalue AS DECIMAL(20,4))) AS vmax,SUM(CAST(gavalue AS DECIMAL(20,4))) AS vsum FROM (SELECT gavalue FROM edomiLive.archivKoData WHERE (targetid=".$E[2]['value']." AND UNIX_TIMESTAMP(datetime)>=".strtotime('now -'.$E[1]['value'].' days').")) void");}
				else if ($E[3]['value']==5) {$ss1=sql_call("SELECT COUNT(gavalue) AS vanz,AVG(CAST(gavalue AS DECIMAL(20,4))) AS vavg,MIN(CAST(gavalue AS DECIMAL(20,4))) AS vmin,MAX(CAST(gavalue AS DECIMAL(20,4))) AS vmax,SUM(CAST(gavalue AS DECIMAL(20,4))) AS vsum FROM edomiLive.archivKoData WHERE (targetid=".$E[2]['value'].")");}
