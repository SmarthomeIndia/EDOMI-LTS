...
<table cellpadding='0' cellspacing='0' border='0' style='position:absolute; left:0; top:0; width:100%; height:100%;'>";
    ...
    n+="
    <tr>
        <td colspan='3' align='center' style='border-top:1px dotted;'>"+((isPreview)?"":"<span class='app2_pseudoElement'>DATENARCHIV</span>")+"</td>
    </tr>
    ";
    n+="
</table>";
        ...
        <table cellpadding='2' cellspacing='0' width='100%' border='0' style='table-layout:auto;'>";
            ...
            while ($n = sql_result($ss1)) {
                ...
                <tr valign='top'>";
                    ...
                    ?>
                    n+="
                    <td align='left' style='word-break:break-all;'><? echo escapeString($n['gavalue'], 1); ?>&nbsp;</td>
                    ";
                    n+="
                <tr>
                    <td colspan='2'>
...
###[HELP]###
Das Visuelement "Datenarchiv" stellt den Inhalt eines
<link>konfigurierten Datenarchivs***1000-50</link> in der Visualisierung tabellarisch dar.
...
<ul>
    <li>Datenarchiv: Auswahl des
        <link>
        konfigurierten Datenarchivs***1000-50</link>, dessen Inhalt angezeigt werden soll
    </li>
    ...
    <li>
        ...
        <ul>
            <li>hier werden Pfeil-Schaltflächen zum Blättern durch die Einträge (Scrollen), sowie der Name des
                <link>
                Datenarchivs***1000-50</link> angezeigt
            </li>
