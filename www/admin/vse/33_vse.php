...
return "
<line x1='"+x1+"' y1='"+y1+"' x2='"+x2+"' y2='"+y2+"' stroke='"+visu_indiColor+"' stroke-width='2' vector-effect='non-scaling-stroke' fill='none'/>";
}
...
return "
<line x1='"+p1.x+"' y1='"+p1.y+"' x2='"+p2.x+"' y2='"+p2.y+"' stroke-linecap='butt' stroke='"+visu_indiColor+"' stroke-width='2'
...
if (r>=1) {
return "
<circle cx='50%' cy='50%' r='"+(r-1)+"' stroke='"+visu_indiColor+"' stroke-width='2' vector-effect='non-scaling-stroke' fill='none'/>";
}
return "";
}
}
...
<ul>
    <li>
        ...
        <ul>
            ...
            <li>relativ: Der Wert von KO2 wird relativ zum aktuellen Wert (KO1) verändert, d.h. das Touchpad kann an einer beliebigen Position "angefasst"
                werden, ohne dass eine Wertänderung erfolgt. Erst beim Bewegen wird der Wert relativ zu dieser Startposition abgeändert.
            </li>
            <li>absolut: Der Wert von KO2 wird unabhängig vom aktuellen Wert (KO1) gesetzt, d.h. beim "Anfassen" des Touchpads wird bereits der mit dieser
