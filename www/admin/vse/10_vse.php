...
<table cellpadding='0' cellspacing='0' border='0' style='width:100%; height:100%;'>";
    ...
    <tr id='e-"+elementId+"-mode2' style='display:none;'>
        <td><input id='e-"+elementId+"-edit' type='"+((obj.dataset.var1==0)?"text":"password")+"' value='' onBlur='VSE_VSEID_Blur(\""+elementId+"\");'
                   onKeyUp='VSE_VSEID_KeyDown(\""+elementId+"\");' class='controlInputTagBlank'
                   style='left:0; top:0; background:"+visu_indiColor+"; color:"+visu_indiColorText+";'></td>
    </tr>
    ";
    n+="
</table>";
...
<ul>
    ...
    <li>
        Eingabe abschließen (KO2-Wert setzen): legt fest, auf welche Weise die Eingabe abgeschlossen und der KO2-Wert auf den Inhalt der Eingabe gesetzt werden
        soll
        <ul>
            <li>nur mit Enter-Taste: die Eingabe wird nur mittels der Enter-Taste übernommen (jeder Verlust des Eingabefokus verwirft die Eingabe, z.B. durch
                einen Klick ausserhalb des Visuelements oder bei einem Seitenwechsel ohne Nutzerinteraktion)
            </li>
            <li>mit Enter-Taste und bei Fokusverlust: die Eingabe wird mittels der Enter-Taste oder durch den Verlust des Eingabefokus übernommen (jeder Verlust
                des Eingabefokus führt zur Übernahme der Eingabe, z.B. durch einen Klick ausserhalb des Visuelements oder bei einem Seitenwechsel ohne
                Nutzerinteraktion)
            </li>
        </ul>
    </li>
...
<ul>
    <li>Sofern nur die Eingabe von Zahlen erlaubt werden soll, müssen die Eigenschaften Minimum und/oder Maximum angegeben werden (im Visuelement bzw. in den
        KO-Einstellungen). Andernfalls können sowohl Zahlen, als auch Texte eingegeben werden.
    </li>
