...
VSE_VSEID=function(elementId,obj,meta,property,isPreview,koValue) {
	...
	var n="<table cellpadding='0' cellspacing='0' border='0' style='width:100%; height:100%;'>";
		n+="<tr valign='top'>";
			n+="<td align='left' style='padding-left:5%; padding-top:5%; width:50%;'>"+tmp[0]+"</td>";
			n+="<td align='right' style='padding-right:5%; padding-top:5%; width:50%;'>"+tmp[1]+"</td>";
		n+="</tr>";
		n+="<tr valign='bottom'>";
			n+="<td align='left' style='padding-left:5%; padding-bottom:5%; width:50%;'>"+tmp[2]+"</td>";
			n+="<td align='right' style='padding-right:5%; padding-bottom:5%; width:50%;'>"+tmp[3]+"</td>";
		n+="</tr>";
	n+="</table>";
	...
	n+="</div>";
	n+="<div style='position:absolute; left:0; top:0; right:0; bottom:0;'><table cellpadding='0' cellspacing='0' border='0' style='width:100%; height:100%;'><tr><td>"+meta.itemText+"</td></tr></table></div>";
	obj.innerHTML=n;
...
VSE_VSEID_CONSTRUCT=function(elementId,obj) {
	if (!(obj.dataset.var1&3)) { 
		...
		if (obj.dataset.var3&2) {
			n+="<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0'>";
				n+="<tr valign='top'>";
					n+="<td align='left' style='padding-left:5%; padding-top:5%; width:50%;'>&nbsp;</td>";
					n+="<td align='right' style='padding-right:5%; padding-top:5%; width:50%;'>&nbsp;</td>";
				n+="</tr>";
				n+="<tr valign='bottom'>";
				n+="<td id='e-"+elementId+"-off' align='left' style='padding-left:5%; padding-bottom:5%; width:50%;'><div id='e-"+elementId+"-offcaption' style='display:inline-block; padding:2px; border-radius:2px;'>"+((obj.dataset.var3&1)?graphics_svg_icon(0):"&nbsp;")+"</div></td>";
				n+="<td id='e-"+elementId+"-on' align='right' style='padding-right:5%; padding-bottom:5%; width:50%;'><div id='e-"+elementId+"-oncaption' style='display:inline-block; padding:2px; border-radius:2px;'>"+((obj.dataset.var3&1)?graphics_svg_icon(1):"&nbsp;")+"</div></td>";
				n+="</tr>";
			n+="</table>";
		}
		n+=getContent();
		...
		n+="<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0'>";
			n+="<tr valign='top'>";
				n+="<td id='e-"+elementId+"-wheel1' align='left' style='padding-left:5%; padding-top:5%; width:50%;'><div id='e-"+elementId+"-wheel1caption' style='display:inline-block; padding:2px; border-radius:2px;'>"+((obj.dataset.var3&1)?"R":"&nbsp;")+"</div></td>";
				n+="<td id='e-"+elementId+"-wheel2' align='right' style='padding-right:5%; padding-top:5%; width:50%;'><div id='e-"+elementId+"-wheel2caption' style='display:inline-block; padding:2px; border-radius:2px;'>"+((obj.dataset.var3&1)?"G":"&nbsp;")+"</div></td>";
			n+="</tr>";
			n+="<tr valign='bottom'>";
				n+="<td id='e-"+elementId+"-off' align='left' style='padding-left:5%; padding-bottom:5%; width:50%;'><div id='e-"+elementId+"-offcaption' style='display:inline-block; padding:2px; border-radius:2px;'>"+((obj.dataset.var3&1)?graphics_svg_icon(0):"&nbsp;")+"</div></td>";
				n+="<td id='e-"+elementId+"-wheel3' align='right' style='padding-right:5%; padding-bottom:5%; width:50%;'><div id='e-"+elementId+"-wheel3caption' style='display:inline-block; padding:2px; border-radius:2px;'>"+((obj.dataset.var3&1)?"B":"&nbsp;")+"</div></td>";
			n+="</tr>";
		n+="</table>";
		n+=getContent();
		obj.innerHTML=n;
		...
		n+="<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0'>";
			n+="<tr valign='top'>";
				n+="<td id='e-"+elementId+"-wheel1' align='left' style='padding-left:5%; padding-top:5%; width:50%;'><div id='e-"+elementId+"-wheel1caption' style='display:inline-block; padding:2px; border-radius:2px;'>"+((obj.dataset.var3&1)?"H":"&nbsp;")+"</div></td>";
				n+="<td id='e-"+elementId+"-wheel2' align='right' style='padding-right:5%; padding-top:5%; width:50%;'><div id='e-"+elementId+"-wheel2caption' style='display:inline-block; padding:2px; border-radius:2px;'>"+((obj.dataset.var3&1)?"S":"&nbsp;")+"</div></td>";
			n+="</tr>";
		if (obj.dataset.var3&2) {
			n+="<tr valign='bottom'>";
				n+="<td id='e-"+elementId+"-off' align='left' style='padding-left:5%; padding-bottom:5%; width:50%;'><div id='e-"+elementId+"-offcaption' style='display:inline-block; padding:2px; border-radius:2px;'>"+((obj.dataset.var3&1)?graphics_svg_icon(0):"&nbsp;")+"</div></td>";
	...
	function getContent() {
		var n="";
		n+="<div id='e-"+elementId+"-svgcontainer' style='display:block; position:absolute; left:0; top:0; width:100%; height:100%; pointer-events:none;'>";
			n+="<svg id='e-"+elementId+"-svg' style='display:block; left:0; top:0; width:100%; height:100%; box-sizing:border-box; pointer-events:none;'></svg>";
		n+="</div>";
		...
		n+="</table>";
		n+="<div id='e-"+elementId+"-wheel0' style='position:absolute; left:0; top:0; width:100%; height:100%; box-sizing:border-box; border-radius:100%;'></div>";
		if (obj.dataset.var2&4) {n+="<div id='e-"+elementId+"-editvalue' style='display:none; position:absolute; left:0; top:0; right:0; bottom:0; color:"+visu_indiColorText+"; pointer-events:none;'></div>";}
		return n;
	}
}
...
VSE_VSEID_render=function(elementId,isActive,koValue) {
	...
	function radialLine(fgcolor,w,h,a,para) {
		...
		return "<line x1='"+p1.x+"' y1='"+p1.y+"' x2='"+p2.x+"' y2='"+p2.y+"' stroke-linecap='butt' stroke='"+fgcolor+"' stroke-width='"+para.width+"' vector-effect='non-scaling-stroke'/>";
	}

	function centerCircleFill(color,w,h,para) {
		if (w>=h) {var r=h/2;} else {var r=w/2;}
		if ((r*para.size/100-1/2)<=0) {return "";}
		return "<circle cx='50%' cy='50%' r='"+(r*para.size/100-1/2)+"' stroke='none' vector-effect='non-scaling-stroke' fill='"+color+"'/>";
	}

	function centerCircle(fgcolor,w,h,para) {
		if (w>=h) {var r=h/2;} else {var r=w/2;}
		if ((r*para.size/100-1/2)<=0) {return "";}
		return "<circle cx='50%' cy='50%' r='"+(r*para.size/100-1/2)+"' stroke='"+fgcolor+"' stroke-width='"+para.width+"' vector-effect='non-scaling-stroke' fill='none'/>";
	}
...
<ul>
	<li>
		...
		<ul>
			...
			<li>Inkrementalgeber: Der Dimmer verhält sich wie ein Inkrementalgeber, d.h. bei jeder Winkeländerung von 5 Grad wird der Wert je nach Drehrichtung erhöht oder erniedrigt.</li>
			<li>Potentiometer: der Dimmer verhält sich wie ein Potentiometer mit einem Bewegungsumfang von 0..360 Grad</li>
			<li>Hinweis: Der Wert von KO2 wird stets relativ zum aktuellen Wert (KO1) verändert, d.h. der Drehregler des Dimmers kann an einer beliebigen Position "angefasst" werden, ohne dass eine Wertänderung erfolgt. Erst beim Bewegen des Drehreglers wird der Wert relativ zu dieser Startposition abgeändert.</li>
		</ul>
	</li>
	...
	<li>
		...
		<ul>
			<li>Dimmwert: der Bereich innerhalb des Drehreglers wird mit dem aktuellen Farb- bzw. Helligkeitswert ausgefüllt, die Helligkeit wird dabei als Transparenz visualisiert (eine geringe Helligkeit führt zu einer hohen Transparenz der angezeigten Füllung)</li>
			<li>EIN-Indikator: die innere Umrandung des Drehreglers wird in der aktuellen Farbe angezeigt, jedoch stets mit maximaler Helligkeit (dies ermöglicht eine visuelle Kontrolle den EIN-Zustands auch bei gering eingestellter Helligkeit)</li>
			<li>Hinweis: Während der Bedienung des Visuelements wird stets der aktuelle Farb- bzw. Helligkeitswert (wie bei "Dimmwert" beschrieben) angezeigt.</li>
		</ul>
	</li>
	...
	<li>
		...
		<ul>
			...
			<li>ein Wert von 0(%) führt dazu, dass der zentrale Drehregler nicht angezeigt wird: Die Einstellung des Dimm- bzw. Helligkeitswertes ist dann nicht mehr möglich, jedoch können die Schaltflächen H/S bzw. R/G/B dennoch bedient werden.</li>
	...
	<li>
		...
		<ul>
			...
			<li>Beschriftung: zeigt die Beschriftung der Schaltflächen an oder blendet diese aus (z.B. für eine eigene Beschriftung mit Hilfe eines hinterlegten Bildes)</li>
	...
	<li>
		...
		<ul>
			...
			<li>nur RGB/HS-Schaltflächen: beim Anklicken und Einstellen der RGB- bzw. HS-Werte wird der Klick-Indikator für die entsprechende Schaltfläche angezeigt</li>
			<li>alle Schaltflächen: der Klick-Indikator wird bei allen o.g. Schaltflächen angezeigt</li>
			<li>Hinweis: Der Klick-Indikator wird nur für die jeweilige <i>Beschriftung</i> der Schaltfläche angezeigt, nicht für die gesamte Schaltfläche. Werden die Schaltflächen nicht beschriftet, wird auch kein Klick-Indikator angezeigt.</li>
		</ul>
	</li>
	...
	<li>
		Verbundenes Visuelement (Knopf): falls ein Visuelement mit dem Dimmer <link>verbunden***2</link> wurde, wird das verbundene Visuelement an der aktuellen Knopf-Position angezeigt (ggf. auch rotiert)
		<ul>
			<li>Radius: relativer Abstand des verbundenen Visuelements vom Mittelpunkt der grafischen Anzeige des Dimmers (siehe "Größe"), erlaubt sind Angaben im Bereich -&infin;..&infin;</li>
...
Im Zentrum des Visuelements ist ein Drehregler positioniert (Bedienung siehe Visuelement <link>Drehregler***1002-11</link>), der zur Einstellung eines gewählten Parameters dient. Um diesen Drehregler herum sind bis zu 4 Schaltflächen angeordnet, die entweder durch Anklicken unittelbar eine Aktion ausführen (Ein/Aus) oder zur Definition des gewünschten Drehregler-Parameters (R/G/B, bzw. H/S) dienen (Anklicken und Festhalten).
