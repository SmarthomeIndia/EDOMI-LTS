...
<table cellpadding='0' cellspacing='0' border='0' style='left:0; top:0; width:100%; height:100%;'>";
    n+="
    <tr>
        <td>"+((isPreview)?"":"<span class='app2_pseudoElement'>SKIZZE</span>")+"</td>
    </tr>
    ";
    n+="
</table>";
...
<table cellpadding='0' cellspacing='0' border='0' style='width:100%; height:100%;'>";
    ...
    <tr>
        <td>
            <canvas id='e-"+elementId+"-canvas' style='width:100%; height:100%;'></canvas>
        </td>
    </tr>
    ";
    n+="
...
var tmp=dataString.split(";");
for (var t=0;t
<tmp.length;t++) {polygon[t]=radix_StringToArray(tmp[t],",",36);}
c.clearRect(0,0,w,h);
}
...
for (var tt=2;tt
<pointsMax-4;tt+=2) {c.quadraticCurveTo(polygon[t][tt]/10000*w,polygon[t][tt+1]/10000*h,(polygon[t][tt]/10000*w+polygon[t][tt+2]/10000*w)/2,(polygon[t][tt+1]/10000*h+polygon[t][tt+3]/10000*h)/2);}
...
for (var t=0;t
<r.length;t++) {newArr=newArr.concat(r[t]);}

var newDataString="";
for (var t=0;t
<dataArray.length;t++) {newDataString+=dataArray[t]+";";}
...
<ul>
    <li>Modus: legt die maximal zulässige Anzahl an Polygonen fest (falls nur 1 Polygon zugelassen wird, wird die Skizze vor jedem Zeichenvorgang automatisch
        gelöscht)
    </li>
...
<ul>
    ...
    <li>eine Skizze wird in relativen Koordinaten gespeichert (Vektoren), d.h. eine Skizze skaliert stets mit dem Visuelement (ohne Berücksichtigung des
        Seitenverhältnisses)
    </li>
