...
n+="
<div id='e-"+elementId+"-cursor'
     style='display:none; position:absolute; z-index:99999; left:0; top:0; width:"+obj.dataset.var5+"px; height:"+obj.dataset.var5+"px; border-radius:100%; border-style:solid; border-width:"+obj.dataset.var6+"px; box-sizing:border-box; pointer-events:none;'></div>";
obj.innerHTML=n;
...
Der aktuelle Helligkeits-/RGB-/HSV-Wert an KO1 wird nicht(!) angezeigt, ggf. ist hierzu ein weiteres Visuelement einzusetzen oder KO1 wird wie üblich zur <span
    style="background:#e0ffe0;">Steuerung und Beschriftung</span> verwendet:
