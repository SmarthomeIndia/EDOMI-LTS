...
<table cellpadding='0' cellspacing='0' border='0' style='left:0; top:0; width:100%; height:100%;'>";
    ...
    <tr style='height:"+mheight+"px;'>";
        ...
        <td width='60%' align='center'>
            <div style='max-height:"+mheight+"px; overflow:hidden;'>"+meta.itemText+"</div>
        </td>
        ";
        n+="
        <td width='20%' align='center'>&gt;</td>
    ...
    n+="
    <tr>
        <td colspan='3' style='border-top:1px dotted;'>"+((isPreview)?"":"<span class='app2_pseudoElement'>NOTIZEN</span>")+"</td>
    </tr>
    ";
    n+="
</table>";
...
<table cellpadding='0' cellspacing='0' border='0' style='width:100%; height:100%;'>";
    n+="
    <tr id='e-"+elementId+"-menu1' style='height:"+mheight+"px;'>";
        n+="
    ...
    ";
    n+="
    <tr id='e-"+elementId+"-menu2' style='height:"+mheight+"px; display:none;'>";
        n+="
        <td width='33%' align='center' id='e-"+elementId+"-delete'>Löschen</td>
        ";
        n+="
        <td width='33%' align='center' id='e-"+elementId+"-cancel'>Abbrechen</td>
        ";
        n+="
        <td width='33%' align='center' id='e-"+elementId+"-save'>Speichern</td>
        ";
        n+="
    </tr>
    ";
    n+="
    <tr>
        <td colspan='3' align='left' style='padding:5px; border-top:1px solid;'>";
            n+="
            <div style='position:relative; height:100%;'>";
                n+="
                <div id='e-"+elementId+"-text'
                     style='position:absolute; top:0; left:0; right:0; bottom:0; overflow-x:hidden; overflow-y:auto; word-wrap:break-word;'></div>
                ";
                n+="<textarea id='e-"+elementId+"-textEdit' wrap='off'
                              style='display:none; width:100%; height:100%; word-wrap:break-word; font-family:inherit; font-size:inherit; resize:none; margin:0; padding:0; color:var(--fgc0); background:transparent; border:none; outline:none; tab-size:4; box-sizing:border-box; -webkit-appearance:none;'></textarea>";
                n+="
            </div>
            ";
            n+="
...
<ul>
    <li>
        ...
        <ul>
            ...
            <li>Hinweis: die Verwendung des KO-Wertes zur Steuerung und Beschriftung ergibt in den meisten Fällen keinen Sinn, da der KO-Wert aus den
                Notizinhalten besteht
            </li>
        </ul>
    </li>
