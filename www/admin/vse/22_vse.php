...
VSE_VSEID=function(elementId,obj,meta,property,isPreview,koValue) {
	...
	var n="<table cellpadding='0' cellspacing='0' border='0' style='position:absolute; left:0; top:0; width:100%; height:100%;'>";
		n+="<tr style='height:"+mheight+"px;'>";
			...
			n+="<td width='60%' align='center'><div style='max-height:"+mheight+"px; overflow:hidden;'>"+property[0]+"</div></td>";
			n+="<td width='20%' align='center'>&gt;</td>";
		n+="</tr>";
		n+="<tr><td colspan='3' align='center' style='border-top:1px dotted; border-bottom:1px dotted;'>"+((isPreview)?"":"<span class='app2_pseudoElement'>ZEITSCHALTUHR</span>")+"</td></tr>";
	if (obj.dataset.var3>0) {
		...
		n+="<tr style='height:"+mheight+"px;'><td colspan='3'>";
			n+="<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0'>";
				n+="<tr align='center'>";
					if (obj.dataset.var3 & 1) {n+="<td "+((koValue==0)?"style='background:"+color+";'":"")+">"+graphics_svg_icon(0)+"</td>";}
					if (obj.dataset.var3 & 2) {n+="<td>"+graphics_svg_icon(2)+"</td>";}
					if (obj.dataset.var3 & 1) {n+="<td "+((koValue==1)?"style='background:"+color+";'":"")+">"+graphics_svg_icon(1)+"</td>";}
				n+="</tr>";
			n+="</table>";
		n+="</td></tr>";
	}
...
function PHP_VSE_VSEID($cmd,$json1,$json2) {
	...
	if ($cmd=='zsuEdit') {
		...
		if ($n=sql_result($ss1)) {
			...
			if (isEmpty($fd[10]) || $fd[10]<1 || $fd[10]>31) 	{$fd[10]='';} else {$fd[10]=sprintf("%02d",$fd[10]);}
			if (isEmpty($fd[11]) || $fd[11]<1 || $fd[11]>12) 	{$fd[11]='';} else {$fd[11]=sprintf("%02d",$fd[11]);}
			if (isEmpty($fd[12]) || $fd[12]<0 || $fd[12]>9999) 	{$fd[12]='';} else {$fd[12]=sprintf("%04d",$fd[12]);}
			if (isEmpty($fd[13]) || $fd[13]<1 || $fd[13]>31) 	{$fd[13]='';} else {$fd[13]=sprintf("%02d",$fd[13]);}
			if (isEmpty($fd[14]) || $fd[14]<1 || $fd[14]>12) 	{$fd[14]='';} else {$fd[14]=sprintf("%02d",$fd[14]);}
			if (isEmpty($fd[15]) || $fd[15]<0 || $fd[15]>9999) 	{$fd[15]='';} else {$fd[15]=sprintf("%04d",$fd[15]);}
		} else {
			//Neuer Eintrag
			$fd[0]=-1;
			$fd[1]=0;
...
?>
		var n="<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0'>";
			n+="<tr valign='bottom'>";
				n+="<td>";

					n+="<table cellpadding='2' cellspacing='0' width='100%' height='100%' border='0' style='max-height:200px;'>";
						n+="<tr height='20%'>";
							n+="<td align='right' style='white-space:nowrap;'>";
								n+="<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0' style='table-layout:auto;'>";
									n+="<tr>";
										n+="<td>"+visuElement_formNewInput("<?echo $json1['elementId'];?>",8,2)+"</td>";
										n+="<td width='1' align='center'>&nbsp;:&nbsp;</td>";
										n+="<td>"+visuElement_formNewInput("<?echo $json1['elementId'];?>",9,2)+"</td>";
									n+="</tr>";
								n+="</table>";
							n+="</td>";
							n+="<td colspan='2'>"+visuElement_formNewCheckmulti("<?echo $json1['elementId'];?>",18,"<?if (isEmpty($tmp_auxKo)) {echo 'display:none;';}?>")+"</td>";
						n+="</tr>";
						...
						n+="<tr height='20%'>";
							n+="<td colspan='3' align='left'>";
								n+="<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0'>";
									n+="<tr valign='bottom'>";
										n+="<td width='10%'>"+visuElement_formNewCheck("<?echo $json1['elementId'];?>",1)+"</td>";
										n+="<td width='1%' align='center'>&nbsp;</td>";
										n+="<td width='10%'>"+visuElement_formNewCheck("<?echo $json1['elementId'];?>",2)+"</td>";
										n+="<td width='1%' align='center'>&nbsp;</td>";
										n+="<td width='10%'>"+visuElement_formNewCheck("<?echo $json1['elementId'];?>",3)+"</td>";
										n+="<td width='1%' align='center'>&nbsp;</td>";
										n+="<td width='10%'>"+visuElement_formNewCheck("<?echo $json1['elementId'];?>",4)+"</td>";
										n+="<td width='1%' align='center'>&nbsp;</td>";
										n+="<td width='10%'>"+visuElement_formNewCheck("<?echo $json1['elementId'];?>",5)+"</td>";
										n+="<td width='1%' align='center'>&nbsp;</td>";
										n+="<td width='10%'>"+visuElement_formNewCheck("<?echo $json1['elementId'];?>",6)+"</td>";
										n+="<td width='1%' align='center'>&nbsp;</td>";
										n+="<td width='10%'>"+visuElement_formNewCheck("<?echo $json1['elementId'];?>",7)+"</td>";
									n+="</tr>";
								n+="</table>";
							n+="</td>";
						n+="</tr>";
						...
						n+="<tr height='20%'>";
							n+="<td align='left' colspan='3' style='white-space:nowrap;'>";
								n+="<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0' style='table-layout:auto;'>";
									n+="<tr>";
										n+="<td width='10%'>"+visuElement_formNewInput("<?echo $json1['elementId'];?>",10,2)+"</td>";
										n+="<td width='1%' align='center'>&middot;</td>";
										n+="<td width='10%'>"+visuElement_formNewInput("<?echo $json1['elementId'];?>",11,2)+"</td>";
										n+="<td width='1%' align='center'>&middot;</td>";
										n+="<td width='22%'>"+visuElement_formNewInput("<?echo $json1['elementId'];?>",12,4)+"</td>";
										n+="<td width='1%' align='center'>&nbsp;</td>";
										n+="<td width='10%'>"+visuElement_formNewCheck("<?echo $json1['elementId'];?>",17)+"</td>";
										n+="<td width='1%' align='center'>&nbsp;</td>";
										n+="<td width='10%'>"+visuElement_formNewInput("<?echo $json1['elementId'];?>",13,2)+"</td>";
										n+="<td width='1%' align='center'>&middot;</td>";
										n+="<td width='10%'>"+visuElement_formNewInput("<?echo $json1['elementId'];?>",14,2)+"</td>";
										n+="<td width='1%' align='center'>&middot;</td>";
										n+="<td width='22%'>"+visuElement_formNewInput("<?echo $json1['elementId'];?>",15,4)+"</td>";
									n+="</tr>";
								n+="</table>";
							n+="</td>";
						n+="</tr>";
						...
						n+="<tr height='20%'>";
							n+="<td colspan='3' align='left'>"+visuElement_formNewSelect("<?echo $json1['elementId'];?>",16)+"</td>";
						n+="</tr>";
						
						n+="<tr height='20%' align='center'>";
<?
		if ($fd[0]>0) {
?>
							n+="<td><div class='controlButton' onClick='visuElement_callPhp(\"zsuDelete\",{elementId:\"<?echo $json1['elementId'];?>\",timerId:\"<?echo $json1['timerId'];?>\",dbId:\"<?echo $fd[0];?>\"},null);'>Löschen</div></td>";
							n+="<td><div class='controlButton' onClick='VSE_VSEID_ShowInfo(\"<?echo $json1['elementId'];?>\");'>Abbrechen</div></td>";
							n+="<td><div class='controlButton' onClick='visuElement_callPhp(\"zsuSave\",{elementId:\"<?echo $json1['elementId'];?>\",timerId:\"<?echo $json1['timerId'];?>\",dbId:\"<?echo $fd[0];?>\"},visuElement_formGetValues(\"<?echo $json1['elementId'];?>\"));'><b>Übernehmen</b></div></td>";
<?
		} else {
?>
							n+="<td>&nbsp;</td>";
							n+="<td><div class='controlButton' onClick='VSE_VSEID_ShowInfo(\"<?echo $json1['elementId'];?>\");'>Abbrechen</div></td>";
							n+="<td><div class='controlButton' onClick='visuElement_callPhp(\"zsuSave\",{elementId:\"<?echo $json1['elementId'];?>\",timerId:\"<?echo $json1['timerId'];?>\",dbId:\"<?echo $fd[0];?>\"},visuElement_formGetValues(\"<?echo $json1['elementId'];?>\"));'><b>Erstellen</b></div></td>";
<?
		}
?>
						n+="</tr>";				
...
<?
	...
	if ($cmd=='zsuSave') {
		if (isEmpty($json2[10]) || $json2[10]<1 || $json2[10]>31) 	{$json2[10]=null;}
		if (isEmpty($json2[11]) || $json2[11]<1 || $json2[11]>12) 	{$json2[11]=null;}
		if (isEmpty($json2[12]) || $json2[12]<0 || $json2[12]>9999) {$json2[12]=null;}
		if (isEmpty($json2[13]) || $json2[13]<1 || $json2[13]>31) 	{$json2[13]=null;}
		if (isEmpty($json2[14]) || $json2[14]<1 || $json2[14]>12) 	{$json2[14]=null;}
		if (isEmpty($json2[15]) || $json2[15]<0 || $json2[15]>9999) {$json2[15]=null;}

		//mind. 1 Tag angegeben?
		$dayOk=false;
		for ($t=1;$t<=7;$t++) {
			if ($json2[$t]==1) {$dayOk=true; break;}
		}
...
<?
	...
	if ($cmd=='zsuInfo') {
?>
		var n="<table cellpadding='2' cellspacing='0' width='100%' border='0' style='table-layout:auto;'>";
<?
		$tmp_auxKo=false;
		$tmp=sql_getValue('edomiLive.timer','gaid2','id='.$json1['timerId']);
		if ($tmp>=1) {
		...
		while ($n=sql_result($ss1)) {
			...
			$days='';
			for ($t=0;$t<7;$t++) {
				if ($n['d'.$t]==1) {$days.="<span style='border-bottom:1px solid;'>".substr($global_weekdays[$t],0,2)."</span>&nbsp;";} else {$days.="<span style='border-bottom:1px solid transparent; opacity:0.75;'>".substr($global_weekdays[$t],0,2)."</span>&nbsp;";}
			}
			
			$noDate=true;
			if (isEmpty($n['day1'])) 	{$n['day1']="&middot;&middot;";} else {$n['day1']=sprintf("%02d",$n['day1']); $noDate=false;}
			if (isEmpty($n['month1'])) 	{$n['month1']="&middot;&middot;";} else {$n['month1']=sprintf("%02d",$n['month1']); $noDate=false;}
			if (isEmpty($n['year1'])) 	{$n['year1']="&middot;&middot;&middot;&middot;";} else {$n['year1']=sprintf("%04d",$n['year1']); $noDate=false;}
			if (isEmpty($n['day2'])) 	{$n['day2']="&middot;&middot;";} else {$n['day2']=sprintf("%02d",$n['day2']); $noDate=false;}
			if (isEmpty($n['month2'])) 	{$n['month2']="&middot;&middot;";} else {$n['month2']=sprintf("%02d",$n['month2']); $noDate=false;}
			if (isEmpty($n['year2'])) 	{$n['year2']="&middot;&middot;&middot;&middot;";} else {$n['year2']=sprintf("%04d",$n['year2']); $noDate=false;}
...
?>
				n+="<td valign='middle' width='<?echo $json1['clock'];?>'>";
					var tmp=graphics_svg_clock("var(--fgc0)",<?echo $json1['clock'];?>,<?echo $json1['clock'];?>,{mode:1,pointerWidth:0,scalaOpacity:0,scalaSize:0,scalaWidth:0,scalaMode:0,fulldayOpacity:0,minuteSize:0,hourSize:0,contourWidth:"0"},"<?echo sprintf("%02d",$n['hour']);?>:<?echo sprintf("%02d",$n['minute']);?>");
					n+="<svg style='display:block; width:<?echo $json1['clock'];?>px; height:<?echo $json1['clock'];?>px;'>"+tmp+"</svg>";
				n+="</td>";
<?
			}
?>
				n+="<td>";
					...
					n+="<div style='margin-top:3px; word-break:break-all;'>&gt; <?if (isEmpty($status)) {echo "-?-";} else {echo escapeString($status,1);}?></div>";
				n+="</td>";
				n+="<td align='right'>";
...
<?
			if (!$noDate) {
?>
					n+="<div style='margin-top:3px; white-space:nowrap;'><?echo $n['day1'];?>.<?echo $n['month1'];?>.<?echo $n['year1'];?> <?echo (($n['mode']==0)?'&middot;':'&gt;');?> <?echo $n['day2'];?>.<?echo $n['month2'];?>.<?echo $n['year2'];?></div>";
<?
			}
?>
					n+="<div style='margin-top:3px; word-break:break-all;'><?if ($tmp_auxKo!==false) {if ($n['d7']==1) {echo escapeString($tmp_auxKo,1);} else if ($n['d7']==2) {echo '<s>&nbsp;'; echo escapeString($tmp_auxKo,1); echo '&nbsp;</s>';}}?></div>";
				n+="</td>";
			n+="</tr>";
			n+="<tr><td colspan='<?echo (($json1['clock']>=1)?3:2);?>'><div style='width:100%; height:1px; background:var(--fgc0); opacity:0.25;'></div></td></tr>";
<?
		}
		sql_close($ss1);
?>
...
VSE_VSEID_CONSTRUCT=function(elementId,obj) {
	...
	var n="<table cellpadding='0' cellspacing='0' border='0' style='position:absolute; left:0; top:0; width:100%; height:100%;'>";
		...
		n+="</tr>";
		n+="<tr><td colspan='3' align='center' style='border-top:1px solid;"+((obj.dataset.var3>0)?"border-bottom:1px solid;":"")+"'><div style='position:relative; height:100%;'><div id='e-"+elementId+"-edit' style='position:absolute; top:0; left:0; right:0; bottom:0; overflow-x:hidden; overflow-y:auto;'></div></div></td></tr>";
	if (obj.dataset.var3>0) {
		n+="<tr style='height:"+mheight+"px;'><td colspan='3'>";
			n+="<table cellpadding='0' cellspacing='0' border='0' style='width:100%; height:100%;'>";
				n+="<tr>";
					if (obj.dataset.var3 & 1) {n+="<td id='e-"+elementId+"-off'>"+graphics_svg_icon(0)+"</td>";}
					if (obj.dataset.var3 & 2) {n+="<td id='e-"+elementId+"-add'>"+graphics_svg_icon(2)+"</td>";}
					if (obj.dataset.var3 & 1) {n+="<td id='e-"+elementId+"-on'>"+graphics_svg_icon(1)+"</td>";}
				n+="</tr>";
			n+="</table>";
		n+="</td></tr>";
	}
...
###[HELP]###
Das Visuelement "Zeitschaltuhr" stellt eine <link>konfigurierte Zeitschaltuhr***1000-100</link> in der Visualisierung dar und ermöglicht das Steuern der Zeitschaltuhr, sowie das Hinzufügen und Bearbeiten von Schaltzeiten.
...
<ul>
	<li>Zeitschaltuhr: Auswahl der <link>konfigurierten Zeitschaltuhr***1000-100</link>, die angezeigt und bearbeitet werden soll</li>
	...
	<li>
		...
		<ul>
			...
			<li>Wichtig: Die Zeitschaltuhr kann unabhängig davon stets über das entsprechende KO gesteuert werden, Schaltzeiten können bereits in der Konfiguration der Zeitschaltuhr definiert werden.</li>
		</ul>
	</li>
	...
	<li>Analoguhr: legt fest, ob vor jeder Schaltzeit eine Analoguhr angezeigt werden soll und legt deren Größe in Pixeln fest (keine Skala, nur Stunden-/Minutenzeiger)</li>
...
<ul>
	<li>Bereits in der <link>Konfiguration der Zeitschaltuhr***1000-100</link> können Schaltzeiten fest vorgegeben werden - diese sind in der Visualisierung nicht veränderbar!</li>
...
<ul>
	<li>
		Titelleiste:
		<ul>
			<li>hier werden Pfeil-Schaltflächen zum Blättern durch die Schaltzeiten (Scrollen), sowie der Name der <link>Zeitschaltuhr***1000-100</link> angezeigt</li>
	...
	<li>
		...
		<ul>
			...
			<li>durch Anklicken einer Schaltzeit kann diese bearbeitet oder gelöscht werden (siehe auch: <link>Konfiguration einer Zeitschaltuhr***1000-100</link>)</li>
