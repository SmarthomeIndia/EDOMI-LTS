...
<table cellpadding='0' cellspacing='0' border='0' style='left:0; top:0; width:100%; height:100%;'>";
    if (obj.dataset.var11==3) {n+="
    <tr>
        <td align='"+imgAlign+"' style='padding:"+obj.dataset.var14+"px; height:"+obj.dataset.var13+"px;'><img src='"+visuElement_getImageUrl(obj,1)+"'
                                                                                                               valign='middle' draggable='false'
                                                                                                               style='margin:0; width:auto; height:"+obj.dataset.var13+"px;'>
        </td>
    </tr>
    ";}
    n+="
    <tr>";
        if (obj.dataset.var11==1) {n+="
        <td valign='"+imgAlign+"' style='padding:"+obj.dataset.var14+"px; width:"+obj.dataset.var13+"px;'><img src='"+visuElement_getImageUrl(obj,1)+"'
                                                                                                               valign='middle' draggable='false'
                                                                                                               style='margin:0; width:"+obj.dataset.var13+"px; height:auto;'>
        </td>
        ";}
        n+="
        <td valign='"+textAlign+"'>
            <div
                style='padding:"+obj.dataset.var6+"px "+((obj.dataset.var11>0)?visuElement_getCssProperty(obj,"padding-right","0px"):"0px")+" "+obj.dataset.var6+"px "+((obj.dataset.var11>0)?visuElement_getCssProperty(obj,"padding-left","0px"):"0px")+";'>
                "+meta.itemText+"
            </div>
        </td>
        ";
        if (obj.dataset.var11==2) {n+="
        <td valign='"+imgAlign+"' style='padding:"+obj.dataset.var14+"px; width:"+obj.dataset.var13+"px;'><img src='"+visuElement_getImageUrl(obj,1)+"'
                                                                                                               valign='middle' draggable='false'
                                                                                                               style='margin:0; width:"+obj.dataset.var13+"px; height:auto;'>
        </td>
...
<table cellpadding='0' cellspacing='0' border='0' style='left:0; top:0; width:100%; height:100%;'>";
    if (obj.dataset.var11==3) {n+="
    <tr>
        <td align='"+imgAlign+"' style='padding:"+obj.dataset.var14+"px; height:"+obj.dataset.var13+"px;'><img id='e-"+elementId+"-icon' src='' valign='middle'
                                                                                                               draggable='false'
                                                                                                               style='margin:0; width:auto; height:"+obj.dataset.var13+"px;'>
        </td>
    </tr>
    ...
    <tr>";
        if (obj.dataset.var11==1) {n+="
        <td valign='"+imgAlign+"' style='padding:"+obj.dataset.var14+"px; width:"+obj.dataset.var13+"px;'><img id='e-"+elementId+"-icon' src='' valign='middle'
                                                                                                               draggable='false'
                                                                                                               style='margin:0; width:"+obj.dataset.var13+"px; height:auto;'>
        </td>
        ";}
        n+="
        <td valign='"+textAlign+"'>
            <div id='e-"+elementId+"-text'
                 style='padding:"+obj.dataset.var6+"px "+((obj.dataset.var11>0)?visuElement_getCssProperty(obj,"padding-right","0px"):"0px")+" "+obj.dataset.var6+"px "+((obj.dataset.var11>0)?visuElement_getCssProperty(obj,"padding-left","0px"):"0px")+";'></div>
        </td>
        ";
        if (obj.dataset.var11==2) {n+="
        <td valign='"+imgAlign+"' style='padding:"+obj.dataset.var14+"px; width:"+obj.dataset.var13+"px;'><img id='e-"+elementId+"-icon' src='' valign='middle'
...
<ul>
    ...
    <li>
        Hintergrundbild: legt diverse Darstellungsparameter des ggf. im
        <link>
        Design***1003</link> definierten Hintergrundbildes fest
        <ul>
            ...
            <li>Wiederholung: gibt an, ob und in welche Richtung das Hintergrundbild ggf. wiederholt/gekachelt wird (nur mit der Skalierungs-Option
                "individuelle Größe" sinnvoll)
            </li>
        </ul>
    </li>
...
<ul>
    <li>Dieses Visuelement verhält sich nur dann
        <link>
        klicktransparent***1002</link>, wenn keine Seitensteuerungen/Befehle <i>und</i> kein KO2 zugewiesen wurden!
    </li>
</ul>
