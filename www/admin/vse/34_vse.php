...
VSE_VSEID=function(elementId,obj,meta,property,isPreview,koValue) {
	if (isPreview) {
		...
		var n="<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0'><tr><td><span class='app2_pseudoElement'>BEFEHLE</span></td></tr></table>";
	}
	obj.innerHTML=n;
...
<ul>
	<li>
		KO1: Steuerung
		<ul>
			<li>dieses KO wird ausschließlich zur Ausführung der Seitensteuerungen/Befehle (s.o.) verwendet, indem dessen Wert mit der Angabe im Feld "Beschriftung" verglichen wird</li>
		</ul>
	</li>
</ul>
...
<ul>
	...
	<li>das Feld "Beschriftung" wird <i>nicht</i> zur <span style="background:#e0ffe0;">Steuerung und Beschriftung</span> verwendet, sondern repräsentiert ausschließlich den KO-Vergleichswert zur KO-gesteuerten Ausführung der Befehle</li>
