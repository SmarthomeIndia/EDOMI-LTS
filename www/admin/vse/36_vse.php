...
<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0'>
    <tr>
        <td><span class='app2_pseudoElement'>WEITERLEITUNG</span></td>
    </tr>
</table>";
}
obj.innerHTML=n;
...
<ul>
    <li>
        ...
        <ul>
            <li>bei Seitenaufruf: die Ausführung erfolgt ggf. bei jedem Aufruf der Visuseite, die dieses Visuelement enthält (sofern der KO1-Wert den
                Bedingungen entspricht bzw. nicht entspricht)
            </li>
            <li>KO-gesteuert: die Ausführung erfolgt ggf. immer dann, wenn der sich Wert des KO1 ändert (sofern der KO1-Wert den Bedingungen entspricht bzw.
                nicht entspricht)
            </li>
...
<ul>
    <li>
        ...
        <ul>
            <li>KO-Wert(e): KO-Wert (ggf. auch mehrere), die zu einem Aufruf der zugewiesenen Visuseite führen (mehrere Werte sind mit einem Semikolon zu
                separieren, z.B. "1;2;3")
            </li>
...
<ul>
    <li>
        ...
        <ul>
            <li>Seitensteuerung bei Weiterleitung: bei einer erfolgreichen Weiterleitung (KO1-Wert entspricht einer der Angaben) kann optional das aktuelle
                Popup (auf dem sich dieses Visuelement befindet) geschlossen werden
            </li>
            <li>Seitensteuerung wenn keine Weiterleitung: bei einer nicht erfolgten Weiterleitung (KO1-Wert entspricht nicht den Angaben) können optional die
                entsprechenden Seitensteuerungen des Visuelements ausgeführt werden
            </li>
...
<ul>
    <li>
        KO1: Steuerung
        <ul>
            <li>dieses KO wird ausschließlich zur Ausführung der Weiterleitung (s.o.) verwendet, indem dessen Wert mit den Angaben im Feld "KO-Wert(e)"
                verglichen wird
            </li>
        </ul>
    </li>
...
<ul>
    <li>
        ...
        <ul>
            <li>wird die Visuseite, die das Visuelement enthält erneut aufgerufen, erfolgt die Ausführung der Weiterleitung bzw. der Seitensteuerungen/Befehle
                ggf. erneut
            </li>
        </ul>
    </li>
