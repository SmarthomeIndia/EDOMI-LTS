...
<table cellpadding='0' cellspacing='0' border='0' style='position:absolute; left:0; top:0; width:100%; height:100%;'>";
    ...
    n+="
    <tr>
        <td align='center' style='border-top:1px dotted; border-bottom:1px dotted;'>"+((isPreview)?"":"<span
                class='app2_pseudoElement'>ANWESENHEITSSIMULATION</span>")+"
        </td>
    </tr>
    ";
    ...
    <tr style='height:"+mheight+"px;'>
        ...
        n+="
        <td
        "+((koValue==2)?"style='background:"+color+";'":"")+">"+graphics_svg_icon(4)+"</td>";
        n+="
        <td
        "+((koValue==1)?"style='background:"+color+";'":"")+">"+graphics_svg_icon(3)+"</td>";
        n+="
    </tr>
    ";
    n+="
    ...
    if ($cmd == 'awsInfo') {
        ...
        <table width='100%' height='100%' border='0' cellspacing='0' cellpadding='0'>";
            ...
            <tr valign='middle'>
                <td align='center'>";
                    n+="
                    <table width='80%' height='80%' border='0' cellspacing='0' cellpadding='3'>";
                        n+="
                        <tr height='80%' align='center' valign='bottom'>";
                            <?
                            $maxAnz = max($anz);
                            for ($t = 1; $t <= 7; $t++) {
                                if ($anz[$t] > 0) {
                                    $y = intVal(100 / $maxAnz * $anz[$t]);
                                } else {
                                    $y = 0;
                                }
                                ?>
                                n+="
                                <td>
                                    <div style='width:1px; height:<? echo $y; ?>%; border:1px solid; opacity:0.75;'></div>
                                </td>";
                                <?
                            }
                            ?>
                        ...
                        ";
                        n+="
                        <tr height='10%' align='center' style='opacity:0.75;'>";
                            <?
                            for ($t = 1; $t <= 7; $t++) {
                                if ($t == date("N")) {
                                    ?>
                                    n+="
                                    <td><span style='border-bottom:1px solid;'><? echo substr($global_weekdays[$t - 1], 0, 2) ?></span></td>";
                                    <?
                                } else {
                                    ?>
                                    n+="
                                    <td><span style='border-bottom:1px solid transparent;'><? echo substr($global_weekdays[$t - 1], 0, 2) ?></span></td>";
                                    <?
                                }
                            }
                            ?>
                        ...
                        <tr height='10%' align='center'>
                            <td style='opacity:0.75;' colspan='7'><? echo $anzTotal; ?> Aufzeichnungen</td>
                        </tr>
                        ";
                        n+="
                    </table>
...
<table cellpadding='0' cellspacing='0' border='0' style='position:absolute; left:0; top:0; width:100%; height:100%;'>";
    n+="
    <tr style='height:"+mheight+"px;'>
        <td align='center' id='e-"+elementId+"-info'>
    ...
    n+="
    <tr>
        <td align='center' style='border-top:1px solid;"+((obj.dataset.var3==1)?"border-bottom:1px solid;":"")+"'>
            <div id='e-"+elementId+"-edit' style='width:100%; height:100%; overflow:hidden;'></div>
        </td>
    </tr>
    ";
        ...
        <td>";
            ...
            <table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0'>";
                ...
                <tr>";
                    ...
                    ";
                    n+="
                    <td id='e-"+elementId+"-rec'>"+graphics_svg_icon(4)+"</td>
                    ";
                    n+="
                    <td id='e-"+elementId+"-play'>"+graphics_svg_icon(3)+"</td>
                    ";
                    n+="
                </tr>
                ";
...
###[HELP]###
Das Visuelement "Anwesenheitssimulation" stellt eine
<link>konfigurierte Anwesenheitssimulation***1000-110</link> in der Visualisierung dar und ermöglicht das Steuern der Anwesenheitssimulation, zudem werden statistische Daten angezeigt.
...
<ul>
    <li>Anwesenheitssimulation: Auswahl der
        <link>
        konfigurierten Anwesenheitssimulation***1000-110</link>, die angezeigt und gesteuert werden soll
    </li>
...
<ul>
    <li>
        ...
        <ul>
            ...
            <li>dieser KO-Wert wird zudem beim Bedienen der Anwesenheitssimulation in der Visualisierung entsprechend gesetzt (Anwesenheitssimulation:
                deaktiviert/Abspielen/Aufnehmen)
            </li>
...
<ul>
    <li>
        Titelleiste:
        <ul>
            <li>hier werden der Name der
                <link>
                Anwesenheitssimulation***1000-110</link> angezeigt
            </li>
    ...
    <li>
        ...
        <ul>
            ...
            <li>Hinweis: es erfolgt keine(!) automatische Aktualisierung z.B. wenn KOs aufgezeichnet werden - erst bei einer Statusänderung (KO) oder durch
                einen Klick auf den Titel (s.o.) wird die Statistik aktualisiert
            </li>
