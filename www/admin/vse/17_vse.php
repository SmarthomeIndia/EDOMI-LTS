...
<ul>
    ...
    <li>
        Zeiger: Stärke
        <ul>
            <li>gibt die Stärke der Stunden-/Minutenzeiger an (Linienstärke in Pixeln): die Angabe von "0" führt zu einer Skalierung in Abhängigkeit von der
    ...
    <li>
        ...
        <ul>
            <li>gibt die radiale Länge des Stunden/-Minutenzeigers an (Strichlänge in Pixeln): die Angabe von "0" führt zu einer Skalierung in Abhängigkeit von
                der Größe des Visuelements
            </li>
    ...
    <li>
        Ziffernblatt: Stärke
        <ul>
            <li>gibt die Stärke des Stunden-/Minutenskala an (Linienstärke in Pixeln): die Angabe von "0" führt zu einer Skalierung in Abhängigkeit von der
                Größe des Visuelements
            </li>
        </ul>
    </li>
    ...
    <li>
        Ziffernblatt: Länge
        <ul>
            <li>gibt die radiale Länge der Stundenskala an (Strichlänge in Pixeln): die Angabe von "0" führt zu einer Skalierung in Abhängigkeit von der Größe
                des Visuelements
            </li>
...
<ul>
    <li>
        ...
        <ul>
            ...
            <li>Hinweis: das KO kann eine Zeitangabe wie "12:00:00" enthalten, oder einen FLOAT-Wert in Minuten (z.B. entspricht "60.5" der Uhrzeit
                "00:01:30")
            </li>
