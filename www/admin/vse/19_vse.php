...
VSE_VSEID=function(elementId,obj,meta,property,isPreview,koValue) {
	...
	n+="<tr style='height:"+mheight+"px;'><td style='"+((obj.dataset.var4&1)?"border-bottom:1px dotted;":"")+"'>"+((obj.dataset.var4&2)?property[0]:"")+"</td></tr>";
	n+="<tr><td>"+((isPreview)?meta.itemText:"<span class='app2_pseudoElement'>KAMERA</span>")+"</td></tr>";
	n+="</table>";
	obj.innerHTML=n;
...
VSE_VSEID_CONSTRUCT=function(elementId,obj) {
	var mheight=(obj.dataset.var10!='')?obj.dataset.var10:40;
	var n="";
	n+="<div id='e-"+elementId+"-viewport' style='display:block; position:absolute; left:0; top:0; width:100%; height:100%;'>";
		n+="<div id='e-"+elementId+"-stream' style='display:none; position:absolute; left:0; top:0; width:100%; height:100%;'></div>";
		n+="<img id='e-"+elementId+"-image' draggable='false' style='display:none; position:absolute; left:0; top:0; width:100%; height:100%;'></img>";
		n+="<canvas id='e-"+elementId+"-canvas' style='display:none; position:absolute; left:0; top:0; width:100%; height:100%;'></canvas>";

		n+="<table cellpadding='0' cellspacing='0' border='0' style='position:absolute; left:0; top:0; width:100%; height:100%;'>";
		n+="<tr id='e-"+elementId+"-zoom' style='height:"+mheight+"px;'><td style='"+((obj.dataset.var4&1)?"border-bottom:1px solid;":"")+"'><span id='e-"+elementId+"-info' style='display:"+((obj.dataset.var4&2)?"inline":"none")+";'></span></td></tr>";
	...
	if (obj) {
		...
		if (veVar) {
			...
			if (status==5) {		//Stream: Ok
				...
				stream.innerHTML="<iframe id='e-"+elementId+"-mjpeg' src='about:blank' style='position:absolute; left:0; top:0; width:100%; height:100%; margin:0; padding:0; border:none; pointer-events:none; overflow:hidden;'></iframe>";
				var mjpeg=document.getElementById("e-"+elementId+"-mjpeg");
				if (mjpeg) {
					mjpeg.contentWindow.document.open('text/htmlreplace');
					mjpeg.contentWindow.document.write("<html><body style='background:transparent; margin:0; padding:0; -webkit-user-select:none;'><img draggable='false' style='position:absolute; left:0; top:0; width:100%; height:100%;' src='"+url+"'></img></body></html>");
...
###[HELP]###
Das Visuelement "Kamera" ermöglicht das Anzeigen eines Livebildes einer <link>konfigurierten Kameraansicht***1000-83</link>. Die Kameraansicht kann ggf. per KO oder manuell per Maus angepasst werden (virtuelles PTZ).

<b>Hinweis:</b>
Die PTZ-Option bewirkt lediglich eine Änderung der <link>Bildbearbeitungs-Einstellungen der konfigurierten Kameraansicht***1020</link>. Die Steuerung echter PTZ-Hardware ist mit diesem Visuelement <i>nicht</i> möglich.
...
<ul>
	<li>
		Kameraansicht: Auswahl einer <link>konfigurierten Kameraansicht***1000-83</link>, deren Livebild angezeigt werden soll
		<ul>
			<li>Wichtig: die direkte Auswahl einer <link>konfigurierten Kamera***1000-81</link> ist nicht möglich, es muss stets eine Kameraansicht konfiguriert und ausgewählt werden</li>
		</ul>
	</li>
	...
	<li>
		...
		<ul>
			<li>MJPEG-Stream direkt einbinden: Ein ggf. konfigurierter MJPEG-Stream wird direkt von der Visualisierung (Client) abgerufen und angezeigt. Die gewählte Kameraansicht wird daher <i>nicht</i> auf den angezeigten Stream angewendet, stattdessen wird der Stream der in der Kameraansicht gewählten Kamera direkt angezeigt.</li>
			...
			<li>Das Aktualisierungsintervall bezieht sich stets auf das letzte erfolgreiche Abrufen eines Kamerabildes: Die Zeitmessung beginnt erst, wenn ein Kamerabild vollständig von der Kamera abgerufen wurde.</li>
			<li>Hinweis: Die Kamerabilder werden u.U. zwischengespeichert, um eine Kamera bei mehrfachen Zugriffen zur selben Zeit zu entlasten (siehe <link>Basis-Konfiguration***a-1</link> bzw. <link>Kameraeinstellungen***1000-81</link>)</li>
		...
		<ul>
			...
			<li>
				...
				<ul>
					...
					<li>Klicken und Ziehen ausserhalb der "Titel-/Zoom-Zeile" verändert den Blickwinkel (bei "360-Grad-Entzerrung") bzw. die Position (bei "Ausschnitt") der Ansicht</li>
				</ul>
			</li>
		</ul>
	</li>
	...
	<li>
		...
		<ul>
			<li>Joystick: eine Mausbewegung z.B. nach links bewirkt ein Schwenken der Ansicht nach links (mit der Maus wird quasi die Schwenkrichtung vorgegeben)</li>
	...
	<li>
		PTZ Auflösung während der manuellen Steuerung: bei manueller Steuerung kann die Auflösung des Kamerabildes vorübergehend z.B. reduziert werden, um auf leistungsschwachen Endgeräten ein ruckelfreies Bewegen zu ermöglichen
		<ul>
			<li>unverändert: die Auflösung wird unverändert aus den Kameraeinstellungen übernommen</li>
			<li>5..100%:  die Auflösung wird während der manuellen Steuerung auf diesen Wert gesetzt, abschließend wird das Kamerabild mit der Auflösung aus den Kameraeinstellungen erneut gerendert</li>
		</ul>
	</li>
</ul>
...
<ul>
	<li>
		...
		<ul>
			<li>Kameraansicht-ID: die ID der <link>konfigurierten Kameraansicht***1000-83</link></li>
	...
	<li>
		beim Wechsel der Kameraansicht ohne die Angabe weiterer Parameter bzw. beim ersten Aufruf (Seitenaufbau) des Visuelements werden die Vorgaben aus der konfigurierten Kameraansicht übernommen
		<ul>
			<li>"3" (ohne Semikolon oder weitere Angaben!): wechselt zur Kameraansicht "3" und übernimmt dabei die Vorgaben aus der konfigurierten Kameraansicht</li>
		</ul>
	</li>
</ul>
