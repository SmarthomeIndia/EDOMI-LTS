...
var n="
<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0' style='border-collapse:collapse;'>";
    n+="
    <tr align='center'>
        <td style='border-bottom:1px dotted;'>1</td>
        <td style='border-bottom:1px dotted; border-left:1px dotted; border-right:1px dotted;'>2</td>
        <td style='border-bottom:1px dotted;'>3</td>
    </tr>
    ";
    n+="
    <tr align='center'>
        <td style='border-bottom:1px dotted;'>4</td>
        <td style='border-bottom:1px dotted; border-left:1px dotted; border-right:1px dotted;'>5</td>
        <td style='border-bottom:1px dotted;'>6</td>
    </tr>
    ";
    n+="
    <tr align='center'>
        <td style='border-bottom:1px dotted;'>7</td>
        <td style='border-bottom:1px dotted; border-left:1px dotted; border-right:1px dotted;'>8</td>
        <td style='border-bottom:1px dotted;'>9</td>
    </tr>
    ";
    n+="
    <tr align='center'>
        <td style='color:#80ff00;'></td>
        <td style='border-left:1px dotted; border-right:1px dotted;'>0</td>
        <td>-</td>
    </tr>
    ";
    n+="
...
//normal
var n="
<table id='e-"+elementId+"-container' cellpadding='0' cellspacing='0' border='0' style='left:0; top:0; width:100%; height:100%;'>";
    n+="
    <tr align='center'>
        <td id='e-"+elementId+"-k1'>1</td>
        <td id='e-"+elementId+"-k2'>2</td>
        <td id='e-"+elementId+"-k3'>3</td>
    </tr>
    ";
    n+="
    <tr align='center'>
        <td id='e-"+elementId+"-k4'>4</td>
        <td id='e-"+elementId+"-k5'>5</td>
        <td id='e-"+elementId+"-k6'>6</td>
    </tr>
    ";
    n+="
    <tr align='center'>
        <td id='e-"+elementId+"-k7'>7</td>
        <td id='e-"+elementId+"-k8'>8</td>
        <td id='e-"+elementId+"-k9'>9</td>
    </tr>
    ";
    n+="
    <tr align='center'>";
        ...
        <td>";
            ...
            <table cellpadding='0' cellspacing='0' border='0' style='width:100%; height:100%;'>";
                n+="
                <tr id='e-"+elementId+"-mode1'>
                    <td align='center'>
                        <div id='e-"+elementId+"-info' style='color:"+visu_indiColor+";'></div>
                        ";
                        n+="
                <tr id='e-"+elementId+"-mode2' style='display:none;'>
                    <td align='center'><input id='e-"+elementId+"-edit' type='password' value='' onBlur='VSE_VSEID_KeyboardCancel(\""+elementId+"\");'
                                              onKeyUp='VSE_VSEID_KeyboardDown(\""+elementId+"\");' class='controlInputTagBlank'
                                              style='left:0; top:0; background:"+visu_indiColor+"; color:"+visu_indiColorText+";'>";
                        n+="
            </table>
            ";
            n+="
        ...
        ";
        n+="
        <td id='e-"+elementId+"-k0'>0</td>
        <td id='e-"+elementId+"-kd'>-</td>
        ";
        n+="
    </tr>
    ";
...
//mit Tastenkreuz
var n="
<table id='e-"+elementId+"-container' cellpadding='0' cellspacing='0' border='0' style='left:0; top:0; width:100%; height:100%; border-collapse:collapse;'>";
    n+="
    <tr align='center'>
        <td id='e-"+elementId+"-k1' style='border-bottom:1px solid;'>1</td>
        <td id='e-"+elementId+"-k2' style='border-bottom:1px solid; border-left:1px solid; border-right:1px solid;'>2</td>
        <td id='e-"+elementId+"-k3' style='border-bottom:1px solid;'>3</td>
    </tr>
    ";
    n+="
    <tr align='center'>
        <td id='e-"+elementId+"-k4' style='border-bottom:1px solid;'>4</td>
        <td id='e-"+elementId+"-k5' style='border-bottom:1px solid; border-left:1px solid; border-right:1px solid;'>5</td>
        <td id='e-"+elementId+"-k6' style='border-bottom:1px solid;'>6</td>
    </tr>
    ";
    n+="
    <tr align='center'>
        <td id='e-"+elementId+"-k7' style='border-bottom:1px solid;'>7</td>
        <td id='e-"+elementId+"-k8' style='border-bottom:1px solid; border-left:1px solid; border-right:1px solid;'>8</td>
        <td id='e-"+elementId+"-k9' style='border-bottom:1px solid;'>9</td>
    </tr>
    ";
    n+="
    <tr align='center'>";
        ...
        ";
        n+="
        <td id='e-"+elementId+"-k0' style='border-left:1px solid; border-right:1px solid;'>0</td>
        <td id='e-"+elementId+"-kd'>-</td>
        ";
        n+="
    </tr>
