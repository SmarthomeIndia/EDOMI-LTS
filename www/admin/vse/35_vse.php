...
###[HELP]###
Das Visuelement "Skala" generiert eine statische Skala (SVG), z.B. als Hintergrund für eine
<link>Wertanzeige***1002-27</link>.
...
<ul>
    <li>
        ...
        <ul>
            <li>
                ...
                <ul>
                    <li>Hinweis: die Ausrichtung der linearen Skala (horizontal oder vertikal) erfolgt stets automatisch anhand des Seitenverhältnisses
                        (Breite:Höhe): Ist "Breite &ge; Höhe" wird die Skala horizontal ausgerichtet, ansonsten vertikal.
                    </li>
                </ul>
            </li>
    ...
    <li>
        ...
        <ul>
            ...
            <li>bei linearer Wertanzeige: "Größe" legt lediglich die horizontale bzw. vertikale Ausdehung der Skala fest, alle Positionsangaben beziehen sich
                weiterhin auf die Visuelementgröße (Breite bzw. Höhe).
            </li>
            <li>bei polarer Wertanzeige: "Größe" reduziert ggf. den Gesamtdurchmesser der Skala, alle Positionsangaben beziehen sich nunmehr auf die
                neuberechnete Größe der Skala.
            </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    <li>beim Typ "Linear": die Angaben beziehen sich auf den linken bzw. oberen Rand des Visuelements (je nach Ausrichtung), z.B. erzeugt 0%/50%
                        eine Linie vom linken Rand (0%) bis zur Mitte des Visuelements (50%)
                    </li>
                    <li>beim Typ "Polar": die Angaben beziehen sich auf den Radius der Skala, z.B. erzeugt 0%/100% eine Linie vom Mittelpunkt (0%) bis zum
                        äußersten Rand des Visuelements (100%)
                    </li>
                </ul>
            </li>
        </ul>
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    <li>beim Typ "Linear": die Angaben beziehen sich auf den linken bzw. oberen Rand des Visuelements (je nach Ausrichtung), z.B. erzeugt 50%
                        eine Beschriftung in der Mitte des Visuelements (50%)
                    </li>
            ...
            <li>
                Startwert/Endwert: definiert den Start- und Endwert für die Beschriftung (die Zwischenwerte werden abhängig von der Anzahl der Hauptintervalle
                berechnet)
                <ul>
                    ...
                    <li>Hinweis: Beträgt die Ausdehnung der Skala genau 360 Grad (nur bei Typ "Polar"), wird am Anfang bzw. Ende der Skala (0/360 Grad) nur die
                        Beschriftung mit dem höheren Wert angezeigt (z.B. 25,50,75,100 anstelle von 0,25,50,75,100).
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    ...
                    <li>bei einer "Größe" &lt; 100(%): die Beschriftung des ersten/letzten Ticks erfolgt wie bei alle anderen Ticks, so dass diese u.U. nicht
                        vollständig sichtbar ist (die "Größe" ist entsprechend anzupassen)
                    </li>
                </ul>
            </li>
        </ul>
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    <li>beim Typ "Linear": die Angaben beziehen sich auf den linken bzw. oberen Rand des Visuelements (je nach Ausrichtung), z.B. erzeugt 50%
                        eine Begrenzungslinie in der Mitte des Visuelements (50%)
                    </li>
