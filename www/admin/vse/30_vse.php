...
<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0'>
    <tr>
        <td><span class='app2_pseudoElement'>TON-URL</span></td>
    </tr>
</table>";
}
obj.innerHTML=n;
...
<ul>
    <li>
        ...
        <ul>
            <li>Hinweis: es kann stets nur ein Ton zur gleichen Zeit wiedergegeben werden, daher wird die Wiedergabe ggf. abgebrochen sobald eine weitere
                Ton-URL abgespielt werden soll
            </li>
        </ul>
    </li>
</ul>
...
<ul>
    <li>
        ...
        <ul>
            <li>wird im Feld "Beschriftung" des Basis-Designs bereits eine URL angegeben, wird der Ton unmittelbar abgespielt sobald die entsprechende Visuseite
                angezeigt wird
            </li>
            ...
            <li>der
                <link>
                Befehl "Ton abspielen"***1007</link> (z.B. Logik) beendet die aktuelle Wiedergabe und wird dann ausgeführt (Töne werden also nicht "gemischt")
            </li>
        </ul>
    </li>
...
<b>Wichtig:</b>
<link>Konfigurierte Töne***1000-29</link> stehen für dieses Visuelement nur dann (als lokale URL) zu Verfügung, wenn ein konfigurierter Ton in einer Visualisierung tatsächlich genutzt wird (
<link>Befehle***1007</link>): Ungenutzte Ton-Dateien werden bei der
