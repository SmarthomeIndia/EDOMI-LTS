...
VSE_VSEID=function(elementId,obj,meta,property,isPreview,koValue) {
	if (isPreview) {
		...
		var n="<table cellpadding='0' cellspacing='0' width='100%' height='100%' border='0'><tr><td><span class='app2_pseudoElement'>SPRACHAUSGABE</span></td></tr></table>";
	}
	obj.innerHTML=n;
...
<ul>
	<li>
		...
		<ul>
			<li>wird im Feld "Beschriftung" des Basis-Designs bereits ein Text angegeben, wird dieser Text unmittelbar vorgelesen sobald die entsprechende Visuseite angezeigt wird</li>
			...
			<li>der <link>Befehl "Visu/Visuaccount: Sprachausgabe"***1007</link> (z.B. Logik) beendet die aktuelle Sprachausgabe und wird dann ausgeführt (Sprachausgaben werden also nicht "gemischt")</li>
		</ul>
	</li>
