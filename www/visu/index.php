...
sql_connect();
$visuId = preg_replace("/[^0-9]/", '', httpGetVar('visu'));
if (!is_numeric($visuId) || $visuId < 1) {
    $visuId = 0;
}
$loginSid = loginVisu($visuId, httpGetVar('login'), httpGetVar('pass')); ?>
<!DOCTYPE HTML>
<html>
<head>
    ...
    <div style="position:absolute; overflow:auto; top:0; left:0; bottom:0; right:0; display:inline; background:#343434;">
        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
            <tr valign="middle" height="100%">
                <td align="center">
                    <span style="font-size:20px; color:#fffff9;"><img src="../shared/img/edomi-visu.svg" width="192" height="64" valign="middle"
...
<? } else { ?>
    <body onLoad="firstinit(<? echo $visuId; ?>,'<? echo $loginSid; ?>','<? echo global_version; ?>');" onContextMenu="return false;"
          style="font-family:<? echo global_visuFont; ?>; background:<? echo global_visuBgColor; ?>;">
    ...
    <div id="wait" class="appWindow" style="-webkit-animation:none; color:#c0c0c0; background:#343434;">
        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed; ">
                ...
                <td align="center">
                    <div style="position:relative; width:184px; height:184px; border-radius:100%; background:#343434;">
                        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="padding:2px;">
                            ...
                            <tr valign="middle">
                                <td align="center"><img src="../shared/img/edomi-visu.svg" width="96" height="32" valign="middle" style="margin:0;"
                                                        draggable="false"></td>
                            </tr>
            ...
            <tr valign="middle" height="60" style="font-size:10px; color:#595950;">
                <td align="center"><span onClick="self.location.reload();" style="padding:3px; cursor:pointer;">EDOMI <? echo global_version; ?></span> &middot;
                    <span style="padding:3px;">&copy; Long Term Evolution</span></td>
            </tr>
        </table>
    </div>
    ...
    <div id="warn"
         style="display:none; position:absolute; text-align:center; overflow:hidden; top:0; left:0; right:0; pointer-events:none; background:transparent; z-index:99999;"></div>

    <!-- Container für Longclick-Indikator -->
    <div id="longclick" class="indicateLongclick"></div>

    <!-- Container für Login-Dialog -->
    <div id="login" class="appWindow"
         style="display:none; background:url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAAXNSR0IArs4c6QAAAChJREFUCB1jZGBgMAZiZODDhMwDsn2AeAuyIFgApAgmCBeACaIIgAQBzpEEiaAV3YQAAAAASUVORK5CYII=');"></div>
